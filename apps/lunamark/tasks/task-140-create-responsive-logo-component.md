---
id: task-140
title: Create responsive logo React component
status: pending
priority: high
labels:
  - cli
...
Create a React component that renders the logo responsively based on terminal size.
Combines the responsive system with the existing logo renderer.
...
- [ ] Create `packages/cli/src/tui/design-system/logo/logo-component.tsx`
- [ ] Implement responsive logo rendering
- [ ] Support all logo variants (full, medium, compact, minimal)
- [ ] Support gradient palette prop
- [ ] Support optional tagline and version

## Implementation

**File**: `packages/cli/src/tui/design-system/logo/logo-component.tsx`
...
import { STAR_LOGO, SLIM_LOGO, renderCompactLogo } from '../ascii-logo.js';
...
```typescript
import { Box } from 'ink';
import { Logo, BrandMark } from '../design-system/logo/logo-component.js';

function Header({ projectName }) {
  return (
    <Box flexDirection="column" paddingX={1}>
      {/* Auto-responsive logo */}
      <Logo
        palette="stellar"
