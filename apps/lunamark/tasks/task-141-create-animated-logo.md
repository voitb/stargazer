---
id: task-141
title: Create animated logo intro component
status: pending
priority: medium
labels:
  - cli
...
Create an animated logo component with typewriter intro effect.
For use during CLI startup to create a premium first impression.
...
- [ ] Create `packages/cli/src/tui/design-system/logo/animated-logo.tsx`
- [ ] Implement typewriter reveal for logo lines
- [ ] Support gradient coloring during reveal
- [ ] Callback on animation complete
- [ ] Skip animation option

## Implementation

**File**: `packages/cli/src/tui/design-system/logo/animated-logo.tsx`
...
import { Box } from 'ink';
import { AnimatedLogo, useAnimatedIntro } from '../design-system/logo/animated-logo.js';

function StartupScreen() {
  const { isComplete, onComplete, skip } = useAnimatedIntro();
