---
id: task-138
title: Create pulse/glow animation
status: pending
priority: medium
labels:
  - cli
...
Create a pulse/glow effect that oscillates gradient intensity.
Used for focus states and active element highlighting.
...
- [ ] Create `packages/cli/src/tui/design-system/animations/pulse.tsx`
- [ ] Implement intensity oscillation
- [ ] Support wrapping any child component
- [ ] Configurable cycle duration and intensity range

## Implementation

**File**: `packages/cli/src/tui/design-system/animations/pulse.tsx`
...
import { Pulse, Blink, FocusRing } from '../design-system/animations/pulse.js';

function ActiveMenuItem({ children, isActive }) {
  return (
    <FocusRing focused={isActive}>
      {isActive ? (
        <Pulse>
